  ...
  async.waterfall([
    ...
    function(token, done) {
      ...
      User.findOne({ email: req.body.email }, (err, user) => {
        if (err) throw err;
        if (!user) {
          req.flash("error", "That Stonks account doesn't exist.");
    ...
    function(token, user, done) {
      ...
      let smtpTransport = nodemailer.createTransport({
        service: "Gmail",
        auth: {
          user: "miraliahmadli@gmail.com",
          pass: process.env.PASSWORD
        }
      });
      let mailOptions = {
        from: "miraliahmadli@gmail.com",
        to: user.email,
        subject: "Reset your Stonks Password",
  ...
  async.waterfall([
    ...
    function(user, done) {
      ...
      let mailOptions = {
        from: "miraliahmadli@gmail.com",
        to: user.email,
        subject: "Your Stonks Password has been changed",
        text: "Hi " + user.firstName + ",\n\n" +
